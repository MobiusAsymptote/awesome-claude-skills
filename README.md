...
- [Claude-Mem](./claude-mem/) - Persistent memory compression system for Claude Code. Automatically captures tool usage observations, generates semantic summaries, and injects relevant context into future sessions so Claude remembers your project history. *By [@thedotmack](https://github.com/thedotmack)*
