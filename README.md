...
- [rtk](./rtk/) - Reduces token consumption 60-90% by proxying CLI commands (git, cargo, pytest, docker, kubectl, and 100+ others) through RTK (Rust Token Killer) to filter and compress output before it reaches Claude's context.
